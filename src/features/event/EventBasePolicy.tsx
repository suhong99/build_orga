	...
	return (
		<section className="flex flex-col items-center w-full gap-8">
			...
			<div className="flex w-full items-start gap-4.5">
				<ul className="w-full flex flex-col items-center justify-center gap-1 typo-body1-normal text-center text-label-alternative desktop:flex-row desktop:gap-3 desktop:typo-heading2">
